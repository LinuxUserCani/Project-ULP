# Project-ULP
ULP: Unified Linux Programs. AppImage-like but uses shared libraries for smaller application sizes. Mainly composed of Bash scripts.

# What is a UXE file?
.UXE executables are self-extracting tarballs that installs the required libraries system-wide, then executes the binary inside the file.
